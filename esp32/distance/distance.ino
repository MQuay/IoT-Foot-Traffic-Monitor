...
const char* ssid = "";
const char* pword = "";
const String localUrl = "http://";        //url of the on-premise application "localApp"
const String weburl = "http://_";        //url of the web/cloud application "webapp"
...
void get_web_token() {
  if (WiFi.status()==WL_CONNECTED) {
    ...
    // login in to web 
    HTTPClient https;
    if (https.begin(client, weburl + "/login")) {
      https.addHeader("Content-Type", "application/json");
